...
uncert = np.ones_like(spec)*0.01 #change multiplier to change error for whole spectrum 
...
# Parameter names: Average_bsl, PCA1,PCA2, PCA3, PCA4, peak_G1430, std_G1430, G1430_amplitude, peak_G1515, std_G1515, G1515_amplitude, peak_L1635, width_L1635, L1635_amplitude, slope, offset
...
fig, ax = plt.subplots(figsize= (12,6))
plt.plot(x[0,:], data)
plt.plot(x[0,:], L1635.T + Baseline_Solve.T )
